...
import { MessageCircle, Clock, TrendingUp, BookOpen, Users, MapPin, FileText, Sparkles } from "lucide-react"
...
export function ProjectDashboard({ project, onNavigateToModule }: ProjectDashboardProps) {
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-hidden">
      {/* Hero Section with Background - Same style as Project Manager */}
      <section
        className="relative min-h-screen flex flex-col"
        style={{
          backgroundImage: `url(${getProjectBackground(safeProject.id)})`,
      ...
      >
        ...
        <div className="absolute top-0 left-0 right-0 z-30 p-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-xl font-bold text-white">{safeProject.title}</h1>
                <p className="text-sm text-gray-300">Dashboard del Proyecto</p>
              </div>
            </div>
            <div className="flex items-center gap-4">
              {safeProject.genre && (
              ...
              <Badge variant="outline" className="text-green-400 border-green-400 bg-green-500/10">
                {safeProject.progress}% Completado
              </Badge>
            </div>
          </div>
        </div>
        ...
        {/* Content */}
        <div className="relative z-10 p-6 pt-24 max-w-6xl mx-auto w-full">
          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-8">
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-6">
                ...
                <div className="text-center">
                  <h2 className="text-2xl font-bold text-white mb-2">{safeProject.title}</h2>
                  {safeProject.genre && (
                    <Badge className="mb-4 bg-purple-600/20 text-purple-300 border-purple-500/30">{safeProject.genre}</Badge>
                  )}
                  <div className="bg-black/40 backdrop-blur-md rounded-lg p-3 border border-white/20">
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <span className="text-sm font-bold text-purple-400">{safeProject.progress}%</span>
                    </div>
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <Card
                  className="cursor-pointer hover:bg-black/60 transition-all bg-black/40 backdrop-blur-md border border-white/20"
                  onClick={() => onNavigateToModule("dossier")}
                >
                  <CardContent className="p-4 text-center">
                    <Users className="h-8 w-8 text-blue-400 mx-auto mb-2" />
                    <div className="text-2xl font-bold text-white">{safeProject.charactersCount}</div>
                ...
                >
                  <CardContent className="p-4 text-center">
                    ...
                    <div className="text-2xl font-bold text-white">{safeProject.chaptersCount}</div>
                ...
                >
                  <CardContent className="p-4 text-center">
                    ...
                    <div className="text-2xl font-bold text-white">{safeProject.locations.length}</div>
                ...
                >
                  <CardContent className="p-4 text-center">
                    ...
                    <div className="text-2xl font-bold text-white">{safeProject.wordCount.toLocaleString()}</div>
          ...
          <Card className="bg-black/40 backdrop-blur-md border border-white/20">
            <CardHeader>
              ...
              <CardDescription className="text-gray-300">Últimas interacciones con tu equipo de expertos virtuales</CardDescription>
            </CardHeader>
            <CardContent>
              <ScrollArea className="h-96">
                <div className="space-y-4">
                  {recentConversations.map((conversation) => (
                    <div key={conversation.id} className="border border-white/20 rounded-lg p-4 hover:bg-black/60 transition-colors bg-black/20">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center justify-between mb-2">
                            <div className="flex items-center gap-2">
                              <h4 className="font-semibold text-white">{conversation.agentName}</h4>
                              <Badge variant="outline" className={`${getToneColor(conversation.tone)} border-white/30`}>
                          ...
                          <p className="text-sm text-gray-400 mb-2">{conversation.agentRole}</p>

                          <p className="text-gray-200 leading-relaxed mb-3">{conversation.lastMessage}</p>
